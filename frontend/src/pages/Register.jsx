      ...
      >
        <div className="card">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-neutral-dark dark:text-white mb-2">Create Account</h1>
            <p className="text-neutral-muted dark:text-neutral-light/70">Start tracking your finances today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-neutral-muted" />
                <input
                  type="text"
                  name="name"
                  value={formData.name}
